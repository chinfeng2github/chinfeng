...
> 15 年全栈开发经验，近 10 年专注于微服务架构设计、分布式系统治理与研发效能提升。

坐标 **成都**，是一名经验丰富的全栈工程师。在过去 14 年多的时间里，作为技术核心主导了核心系统从单体架构到 Spring Cloud 微服务体系的全链路演进。

热爱端到端地构建产品——从分布式后端架构设计、CI/CD 流水线搭建，到跨平台移动应用开发和云基础设施管理。

### ✨ 我做什么

- 🏗️ **架构与后端** — Spring Cloud 微服务设计、分布式系统、高可用模式
- 📱 **移动端与前端** — React Native、Flutter、Vue3、Tauri2 — 从设计到上架全生命周期
- ⚙️ **DevOps 与基础设施** — Docker、Ansible、Terraform、CI/CD 流水线、ELK 栈、多云资源管理
- 🤖 **AI 集成** — ComfyUI 工作流、Dify AI 流水线、LLM 功能集成
- 🛠️ **跨平台开发** — 独立开发并上架 3 款 iOS/Android App
...
iOS & Android 已上架 **App Store & Google Play**

实时 1v1 视频聊天平台，管理 10+ 服务器节点。负责架构设计、基础设施自动化（Terraform + Ansible）、ELK 数据统计平台、Vue + Tauri2 跨平台客户端开发。
...
| 领域 | 专长 |
| ------- | ------- |
| 🏛️ **架构设计** | 微服务拆分、分布式系统设计、单体到微服务迁移 |
| 📱 **产品交付** | 从概念到上架的端到端交付（3 款独立 App） |
| ⚡ **性能优化** | 高并发优化、Nginx/OpenResty 调优、数据库优化 |
| 🔄 **CI/CD** | Jenkins + Docker + Ansible 自动化流水线、GitLab CI |
| ☁️ **云基础设施** | Terraform IaC、多云编排（AWS / 阿里云） |
| 📊 **监控运维** | Prometheus + Grafana、ELK 日志分析 |
| 👥 **团队领导** | 组建并培养 10+ 人技术团队、敏捷开发流程、代码规范制定 |
